...
```{r wcvi-priors-posts, fig.cap=ifelse(french, "(ref:wcvi-priors-posts-figure-cap-fr)", "(ref:wcvi-priors-posts-figure-cap)")}
...
```{r wcvi-traces, fig.asp=1, fig.cap=ifelse(french, "(ref:wcvi-traces-figure-cap-fr)", "(ref:wcvi-traces-figure-cap)")}
...
```{r wcvi-autocor, fig.asp=1, fig.cap=ifelse(french, "(ref:wcvi-autocor-figure-cap-fr)", "(ref:wcvi-autocor-figure-cap)")}
...
```{r wcvi-pairs, fig.asp=1, fig.cap=ifelse(french, "(ref:wcvi-pairs-figure-cap-fr)", "(ref:wcvi-pairs-figure-cap)")}
...
```{r wcvi-biomass-retro, fig.cap=ifelse(french, "(ref:wcvi-biomass-retro-figure-cap-fr)", "(ref:wcvi-biomass-retro-figure-cap)")}
