...
cap <- paste0("Posterior (5\\textsuperscript{th} percentile, Median, and ",
              ...
              "parameters from the Prince Rupert District major stock ",
...
(ref:prd-pairs-figure) Pairs plots for MCMC output of estimated parameters in for the Prince Rupert District major stock assessment region. See Figure \@ref(fig:prd-traces-figure) for parameter descriptions.
