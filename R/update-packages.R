...
if (tolower(Sys.getenv("USERNAME")) != "grinnellm") {
  ...
  cat(crayon::green("\nRebasing new commits from csasdowntex...\n"))
  shell(
    paste0("cd ", file.path(git_dir, "csasdowntex"), " && git pull --rebase")
  )
...
cat(crayon::green("\nBuilding and installing csasdowntex package...\n"))
devtools::install("csasdowntex", quick = TRUE, dependencies = FALSE)
