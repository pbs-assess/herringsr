...
wcvi.min.esc.rel.50.hr.10.cap.2 <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    rel.sbo.wcvi,
    tibble(
...
wcvi.min.hs.3060.hr.20 <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
wcvi.min.hs.5060.hr.10.cap.2 <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
wcvi.min.esc.rel.50.hr.10.cap.2.slow <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
wcvi.min.hs.3060.hr.20.slow <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
wcvi.min.hs.3060.hr.10.cap.2.slow <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
if(keep_fsar){
  ...
  sog.min.esc.rel.30.hr.20 <- get_hcr_tac_hr(
    hcr(
      sbt.sog,
      rel.sbo.sog,
      tibble(
  ...
  sog.min.hs.3040.hr.30 <- get_hcr_tac_hr(
    hcr(
      sbt.sog,
      sbo.sog,
      tibble(
...
wcvi.min.hs.3060.hr.10.cap.2 <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
wcvi.min.hs.3060.hr.15.cap.2 <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
wcvi.min.hs.5060.hr.10 <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
wcvi.min.hs.5060.hr.15 <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
wcvi.min.esc.rel.30.hr.05 <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    rel.sbo.wcvi,
    tibble(
...
wcvi.consTAC.cap.1 <- get_hcr_tac_hr(
  hcr(
    sbt.wcvi,
    sbo.wcvi,
    tibble(
...
if(keep_fsar){
  ...
  sog.min.hs.3060.hr.15 <- get_hcr_tac_hr(
    hcr(
      sbt.sog,
      sbo.sog,
      tibble(
