...
average age-2 recruitment from `r major_start_yr` to `r major_end_yr` $\bar{R}$;
average age-2 recruitment in `r major_start_yr-1` $\bar{R}_\mli{init}$;
...
cap <- paste0("Posterior (5\\textsuperscript{th}, 50\\textsuperscript{th}, ",
              ...
              "density (MPD) estimates of key parameters for the Central ",
              "Coast major stock assessment region. See Table ",
              "\\@ref(tab:hg-parameter-est-table) for description.")
...
cap <- paste0("Posterior (5\\textsuperscript{th}, 50\\textsuperscript{th}, ",
              "and 95\\textsuperscript{th} percentile) and maximum posterior ",
              "density (MPD) estimates of key parameters for the Strait of ",
...
cap <- paste0("Posterior (5\\textsuperscript{th}, 50\\textsuperscript{th}, ",
              "and 95\\textsuperscript{th} percentile) and maximum posterior ",
              "density (MPD) estimates of key parameters for the West Coast ",
