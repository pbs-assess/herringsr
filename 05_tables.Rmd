...
(ref:ref-points-prd-cap) Posterior (`r confidence_vals[1]*100`\textsuperscript{th}, 50\textsuperscript{th}, and `r confidence_vals[2]*100`\textsuperscript{th} percentile) estimates of proposed reference points for the Prince Rupert District model. See Table \@ref(tab:ref-points-hg) for description.
...
(ref:ref-points-cc-cap) Posterior (`r confidence_vals[1]*100`\textsuperscript{th}, 50\textsuperscript{th}, and `r confidence_vals[2]*100`\textsuperscript{th} percentile) estimates of proposed reference points for the Central Coast model. See Table \@ref(tab:ref-points-hg) for description.
...
(ref:ref-points-sog-cap) Posterior (`r confidence_vals[1]*100`\textsuperscript{th}, 50\textsuperscript{th}, and `r confidence_vals[2]*100`\textsuperscript{th} percentile) estimates of proposed reference points for the Strait of Georgia model. See Table \@ref(tab:ref-points-hg) for description.
...
(ref:ref-points-wcvi-cap) Posterior (`r confidence_vals[1]*100`\textsuperscript{th}, 50\textsuperscript{th}, and `r confidence_vals[2]*100`\textsuperscript{th} percentile) estimates of proposed reference points for the West Coast Vancouver Island model. See Table \@ref(tab:ref-points-hg) for description.
