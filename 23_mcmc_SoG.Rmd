...
(ref:sog-traces-cap-fr) Tracés des résultats de simulation Monte Carlo par chaîne de Markov pour les paramètres estimés
...
paramètres estimés dans la région d’évaluation des stocks majeur du détroit de Georgie.
Voir le tableau \@ref(tab:hg-parameter-est) et la figure \@ref(fig:hg-traces) pour la description.
...
les paramètres estimés dans la region d’évaluation des stocks majeur du détroit de Georgie.
Voir le tableau \@ref(tab:hg-parameter-est) et la figure \@ref(fig:hg-traces) pour la description.
...
(ref:sog-biomass-retro-cap-fr) French captionDensité a posteriori maximale de la biomasse reproductrice
avec des rétrospectives pour la région d'évaluation des stocks majeur du détroit de Georgie.
