...
(ref:sog-biomass-retro-figure) Maximum posterior density biomass with retrospectivces for the Strait of Georgia major stock assessment region.
```{r sog-biomass-retro-figure, fig.cap = "(ref:sog-biomass-retro-figure)"}
biomass.plot.mpd(major_models[[model_ind]])
```

(ref:decision-table-sog) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Strait of Georgia region, rows 1-4 in Table \\@ref(tab:decision-table-sog)")`
...
(ref:decision-table-sog-2) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Strait of Georgia region, rows 5-8 in Table \\@ref(tab:decision-table-sog)")`
...
(ref:decision-table-sog-3) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Strait of Georgia region, row 9 in Table \\@ref(tab:decision-table-sog)")`
