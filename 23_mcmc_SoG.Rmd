...
(ref:hcr-sog-cap) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Strait of Georgia region, rows 1-4 in Table \\@ref(tab:hcr-sog). Red horizontal and vertical lines show median harvest rate, TAC, and projected $\\SB_t$; mean statistics shown with green lines.")`
...
(ref:hcr-sog-2-cap) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Strait of Georgia region, rows 5-8 in Table \\@ref(tab:hcr-sog). Red horizontal and vertical lines show median harvest rate, TAC, and projected $\\SB_t$; mean statistics shown with green lines.")`
...
(ref:hcr-sog-3-cap) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Strait of Georgia region, row 9 in Table \\@ref(tab:hcr-sog). Red horizontal and vertical lines show median harvest rate, TAC, and projected $\\SB_t$; mean statistics shown with green lines.")`
