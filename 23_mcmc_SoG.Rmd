...
estimated parameters for the Strait of Georgia major stock assessment region.
See Table \@ref(tab:hg-parameter-est) and Figure \@ref(fig:sog-traces) for description.
...
(ref:decision-sog-cap) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Strait of Georgia region, rows 1-4 in Table \\@ref(tab:decision-sog). Red horizontal and vertical lines show median harvest rate, TAC, and projected $\\SB_t$; mean statistics shown with green lines.")`
```{r hcr-sog, fig.cap="(ref:decision-sog-cap)"}
region <- "SoG"
...
(ref:decision-sog-2-cap) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Strait of Georgia region, rows 5-8 in Table \\@ref(tab:decision-sog). Red horizontal and vertical lines show median harvest rate, TAC, and projected $\\SB_t$; mean statistics shown with green lines.")`
```{r hcr-sog-2, fig.height=9, fig.cap="(ref:decision-sog-2-cap)"}
region <- "SoG"
probs <- confidence_vals 
...
(ref:decision-sog-3-cap) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Strait of Georgia region, row 9 in Table \\@ref(tab:decision-sog). Red horizontal and vertical lines show median harvest rate, TAC, and projected $\\SB_t$; mean statistics shown with green lines.")`
```{r hcr-sog-3, fig.height=9, fig.cap="(ref:decision-sog-3-cap)"}
region <- "SoG"
probs <- confidence_vals 
