...
french_title: "Mise à jour de l'état des stocks avec application des procédures de gestion pour le hareng du Pacifique (*Clupea pallasii*) en Colombie-Britannique `:` État en 2023 et prévisions pour 2024"
assess_year: 2023
work_done_year: 2024
...
keep_sog <- FALSE       # Keep or omit SoG
```

```{r models, cache=FALSE}
models_dir <- here("models")
major_stock_dir <- list("HG", "PRD", "CC", "SoG", "WCVI")
if(!keep_sog) major_stock_dir <- major_stock_dir[major_stock_dir != "SoG"]
