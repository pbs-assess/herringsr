...
As such, harvest options for `r assess_yr + 1` for PRD, CC, and SoG are reported using MPs that meet the minimum conservation criteria (Table \@ref(tab:decision-table-prd) - Table \@ref(tab:decision-table-sog)).
