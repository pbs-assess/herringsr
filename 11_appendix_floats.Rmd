(ref:app-minor-survey-indices-cap) Spawn index in tonnes of Pacific Herring from `r  minor_end_yr-num_yrs_tab` to `r minor_end_yr` in the minor stock assessment regions (SARs).
...
(ref:app-minor-survey-indices-cap-fr) Indice du frai en tonnes pour le hareng du Pacifique de `r  minor_end_yr-num_yrs_tab` à `r minor_end_yr` dans les régions d’évaluation des stocks (RESs) mineurs.
...
```{r app-minor-survey-indices}
spawn_index_table(tab = minor_surv_short,
                  by_vec = minor_regions_short,
                  first_yr = minor_end_yr-num_yrs_tab,
                  cap = ifelse(french, "(ref:app-minor-survey-indices-cap-fr)",
                               "(ref:app-minor-survey-indices-cap)"),
                  translate = french)
```
...
```{r app-minor-catch, fig.asp=0.45, fig.cap = ifelse(french, "(ref:minor-catch-cap-fr)", "(ref:minor-catch-cap)")}
...
```{r app-minor-weight-at-age, fig.asp=0.375, fig.cap = ifelse(french, "(ref:minor-wa-cap-fr)", "(ref:minor-wa-cap)")}
plot_wa(df = minor_wa,
        circle_age = 3,
        xlim = c(minor_start_yr_plot, minor_end_yr),
        ylim = wa_ylim,
...
```{r app-minor-proportions-at-age, fig.asp=0.45, fig.cap = ifelse(french, "(ref:minor-pa-cap-fr)", "(ref:minor-pa-cap)")}
plot_pa(df = minor_pa,
        age_plus = age_plus,
        conf = ci_level,
        xlim = c(minor_start_yr_plot, minor_end_yr),
...
```{r app-minor-survey-indices, fig.asp=0.45, fig.cap = ifelse(french, "(ref:minor-spawn-index-cap-fr)", "(ref:minor-spawn-index-cap)")}
