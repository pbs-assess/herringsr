...
(ref:app-minor-survey-indices-tab-cap-fr) Indice du frai en tonnes pour le hareng du Pacifique de `r  minor_end_yr-num_yrs_tab` à `r minor_end_yr` dans les régions d’évaluation des stocks (RESs) mineurs.
...
spawn_index_table(tab = minor_surv_short,
                  ...
                  cap = ifelse(french, "(ref:app-minor-survey-indices-tab-cap-fr)",
...
```{r app-minor-survey-indices-fig, fig.asp=0.45, fig.cap = ifelse(french, "(ref:minor-spawn-index-fig-cap-fr)", "(ref:minor-spawn-index-fig-cap)")}
