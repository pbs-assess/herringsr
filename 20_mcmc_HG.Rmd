...
comparative posterior histograms (bars) for Pacific Herring in the Haida Gwaii major stock assessment region.
...
estimated parameters for Pacific Herring in the Haida Gwaii major stock assessment region.
See Table \@ref(tab:hg-parameter-est) for description.
