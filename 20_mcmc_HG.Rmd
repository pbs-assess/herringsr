...
(ref:hg-traces-figure) Trace plots for Markov chain Monte Carlo output of
...
(ref:hg-autocor-figure) Auto-correlation plots for Markov chain Monte Carlo output of
estimated parameters for the Haida Gwaii major stock assessment region.
...
(ref:hg-pairs-figure) Pairs plots for Markov chain Monte Carlo output of
estimated parameters for the Haida Gwaii major stock assessment region.
See Table \@ref(tab:hg-parameter-est-table) and
Figure \@ref(fig:hg-traces-figure) for description.
