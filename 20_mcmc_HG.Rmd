...
(ref:hg-sr-cap) Beverton-Holt stock-recruitment relationship using maximum posterior density estimates for Pacific Herring in the
Haida Gwaii major stock assessment region.
Points show the relationship between spawning biomass in tonnes (t) and the number of age-`r age_first` recruits in millions.
...
The triangle indicates the current year, `r assess_yr`.
The line indicates the predicted stock-recruitment relationship.

(ref:hg-sr-cap-fr) Relation stock-recrutement du modèle Beverton-Holt, établie au moyen d’estimations de la densité a posteriori maximale pour le hareng du Pacifique dans
la région d'évaluation des stocks majeur de Haida Gwaii.
Les points montrent la relation entre la biomasse reproductrice en tonnes (t) et le nombre de recrues d'âge 2 en millions.
...
L’ombrage gris est de plus en plus foncé à mesure que l’on avance dans la série chronologique
Le triangle indique l’année en cours, `r assess_yr`.
La ligne indique le rapport stock-recrutement prévu.
