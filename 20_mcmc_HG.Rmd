...
```{r hg-priors-posts-figure, fig.cap = "(ref:hg-priors-posts-figure-cap)"}
...
```{r hg-traces-figure, fig.asp=1, fig.cap="(ref:hg-traces-figure-cap)"}
...
Figure \@ref(fig:hg-traces-figure-cap) for description.

```{r hg-autocor-figure, fig.asp=1, fig.cap = "(ref:hg-autocor-figure-cap)"}
...
```{r hg-pairs-figure, fig.asp=1, fig.cap = "(ref:hg-pairs-figure-cap)"}
...
```{r hg-biomass-retro-figure, fig.cap = "(ref:hg-biomass-retro-figure-cap)"}
