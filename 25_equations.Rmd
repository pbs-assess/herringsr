...
\begin{equation}\label{eq:iota_a1}
\iota_a = \begin{cases}
\frac{1}{S}, & a=1\\
\iota_{a-1}e^{-M}, & 1<a<A\\
...
\begin{equation}\label{eq:iota_a2}
\iota_a = \begin{cases}
\frac{1}{S}, & a=1\\
...
\begin{equation}\label{eq:N_tas1}
N_{t,a,s}
\end{equation}
...
\begin{equation}\label{eq:N_tas4}
