...
Pacific Herring steady-state age-structured model assuming unequal vulnerability-at-age, age-specific fecundity, and Beverton-Holt recruitment.

### Parameters

\begin{equation}\label{eq:df1}
\Theta = (R_o,h,M)\,; \ \ \ R_o>0; \ \ \ 0.2 \leq h < 1.0; \ \ \ M > 0  
\end{equation}
...
R_e = R_o \frac{\kappa-\frac{\phi_E}{\phi_e}}{\kappa-1}\ \ \ (\text{Beverton-Holt})  
\end{equation}
