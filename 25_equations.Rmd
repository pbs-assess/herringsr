...
Equations \@ref(eq:delta-t) and \@ref(eq:delta-ell) are key for estimating unfished spawning stock biomass and recruitment compensation via the recruitment models. 
