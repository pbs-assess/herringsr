...
which describes the observed length-at-age $l_{a,s}$.
The mean weight-at-age $w_{a,s}$ is given by an allometric relationship, and
...
\dNorm{-0.79}{0.4}, a bounded uniform prior for both the log 
of initial recruitment and average recruitment \dUnif{-5.0}{15.0},
a beta prior for the variance partitioning parameter
$\rho\sim$\dBeta{17:086}{39:0559}, and a gamma prior for the 
inverse total standard deviation parameter
