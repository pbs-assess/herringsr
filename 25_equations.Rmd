...
can also specify an informative prior distribution for each of these parameters. Five distinct prior distributions can be implemented: uniform, normal, lognormal, beta and a gamma distribution.
For the Pacific herring, a bounded recruitment uniform prior was specified for the log of unfished
recruitment U(-5,15), a beta prior was assumed for steepness Beta(10.0,4.92), a normal prior
was specified for the log of natural mortality rate N(-0.79,0.4), a bounded uniform prior for both
the log of initial recruitment and average recruitment U(-5.0,15.0), a beta prior for the variance
partitioning parameter $\rho$$\sim{\beta}$(17:086; 39:0559), and a gamma prior for the inverse total standard deviation parameter $\vartheta$$\sim{\Gamma}$(25; 28:75). 
...
For the AM2 version of the Pacific Herring assessment model the prior on $q_1$ was assumed uninformative $N(0;1)$ and informative for $q_2$ $N(1;0:01)$.
