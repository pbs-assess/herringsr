...
a. Constrain the estimates of annual recruitment to conform to a Beverton-Holt stock-recruit function,

a. Weakly constrain the log recruitment deviations to a normal distribution, and

a. Weakly constrain estimates of log fishing mortality to a normal distribution
...
where $R_t$ is given by Eq.\@ref(eq:R-t), 
...
There are five distinct components that make up the objective function $f$ 
that is being minimized by the iSCAM model:
