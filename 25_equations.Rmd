...
where $N_k$ is the number of relative abundance observations for index $k$ (see Walters and Ludwig,
...
derived from a multinomial distribution (Fournier and Archibald, 1982). 
...
re-weighting (McAllister and Ianelli, 1997; Gavaris and Ianelli, 2002), 
...
minimizing:
  $f$ = negative loglikelihoods+constraints+priors for parameters+survey priors+convergence penalties.
