...
\Theta = \left(R_0,\,h,\,M\right);\,\,\,\,R_0 > 0,\, 0.2 \leq h < 1.0,\, M > 0 
\end{equation}
...
the total biomass each year, $B_{t,s}$, the spawning stock biomass $SB_{t,s}$ 
and the total age-specific total mortality rate, $Z_{t,a,s}$.

The initial numbers-at-age in the first year (Eq. A.31) and the annual recruits
