...
For the steady-state condition of the model, we assume the parameter vector $\Theta$
...
The observed length-at-age $l_{a,s}$ uses the Von-Bertalanffy growth model
