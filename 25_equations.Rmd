...
lognormal $\mathcal{L}(\sigma, \mu)$ where $\sigma$ and $\mu$ are the standard deviation and mean, respectively,
beta $\mathcal{B}(\alpha, \beta)$ where $\alpha$ and $\beta$ are the shape parameters, and
gamma $\mathcal{G}(k, \Theta)$ where $k$ and $\Theta$ are the shape parameters.
For Pacific Herring,
