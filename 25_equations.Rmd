...
1) Uniform $\emph{U}(a, b)$, where $a$ and $b$ are the minima and maxima, respectively,

<!-- TODO: \sigma appears elsewhere; find a different parameter? -->
2) Normal, $\emph{N}(\mu, \sigma^2)$, where $\mu$ and $\sigma^2$ are 
the mean and variance, respectively,

3) Lognormal, $\emph{Lognormal}(\mu, \sigma^2)$, where $\mu$ and $\sigma^2$ 
are the mean and variance, respectively,

<!-- TODO: a and b appear elsewhere; find different parameters? -->
4) Beta, $\emph{Beta}(a, b)$ where $a$ and $b$ are the shape parameters, and 

5) Gamma $\emph{Gamma}(a, b)$ where $a$ and $b$ are the shape parameters.

For Pacific Herring, a bounded uniform prior was specified for the 
log of unfished recruitment $\emph{U}(-5, 15)$,
