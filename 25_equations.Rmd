...
sections. There are four specific elements that make up the vector of the objective
function:


\begin{equation}\label{eq:l-sum}
larrow = l_{C},l_{I},l_{A},l_{\delta}
\end{equation}

To reiterate, these are the likelihood of the catch data $l_{C}$, 
likelihood of the survey data $l_{I}$, 
the likelihood of the age-composition data $l_{A}$, 
