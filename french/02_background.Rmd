...
Bien que le détroit de Georgia (DG) soit évalué à Pêches et Océans Canada (en préparation),$^{\ref{fn:sogfsar}}$ certains tableaux et figures du présent document comprennent des données sur le DG à des fins d’exhaustivité.
...
Pour plus d’informations, voir le PGP de 2023-2024.
