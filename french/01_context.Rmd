...
Il est à noter que la RES du DG est évaluée dans un document\footnote{\label{fn:sogfsar} 
DFO. In Prep. Stock status update with application of management procedures for Pacific Herring (\emph{Clupea pallasii}) in the Strait of Georgia, British Columbia: Status in 2024 and forecast for 2025. DFO Can. Sci. Advis. Sec. Fish. Sci. Advis. Rep.} distinct à l’aide d’un nouveau cadre de modélisation [@johnson2024].
...
La présente réponse des Sciences résulte du processus de réponse des Sciences qui s’est tenu le `r t_process_month` `r rmarkdown::metadata$process_day`, `r rmarkdown::metadata$process_year` sur Mise à jour de l'état des stocks avec application des procédures de gestion pour le hareng du Pacifique (*Clupea pallasii*) en Colombie-Britannique `:` État en 2024 et prévisions pour 2025.
