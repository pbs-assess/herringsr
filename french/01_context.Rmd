...
La présente réponse des Sciences résulte du processus de réponse des Sciences qui s’est tenu le `r t_process_month` `r rmarkdown::metadata$process_day`, `r rmarkdown::metadata$process_year` sur `r rmarkdown::metadata$title`.
