...
```{r major-pa, fig.asp = 1, fig.cap = ifelse(french, "(ref:major-pa-cap-french)", "(ref:major-pa-cap)")}
plot_pa(major_pa,
        age_plus = age_plus,
        conf = ci_level,
        xlim = c(major_start_yr, major_end_yr),
...
```{r major-spawn-index, fig.asp = 1, fig.cap = ifelse(french, "(ref:major-spawn-index-cap-french)", "(ref:major-spawn-index-cap)")}
...
```
<!-- Haida Gwaii Storyboard -->
(ref:storyboard-hg-cap) `r paste0("Model output for Pacific Herring in the Haida Gwaii major stock assessment region. Panel (a): model fit to scaled spawn survey data in thousands of tonnes (t). Spawn survey data (i.e., spawn index) is scaled to abundance by the spawn survey scaling parameter $q$. Panel (b): posterior estimates of instantaneous natural mortality rate. Panel (c): reconstructed number of age-2 recruits in thousands of millions. Panel (d): posterior estimate of spawning biomass ($SB_t$) in year $t$ in thousands of tonnes. Circle and vertical line indicate the median and ", ci_level*100, "\\% credible interval, respectively, of $SB_{", assess_yr + 1, "}$ (pre-fishery). Vertical bars indicate commercial catch, excluding spawn-on-kelp. Panels (b \\& d): lines and shaded areas indicate medians and ", ci_level*100, "\\% credible intervals, respectively. Panel (e): log recruitment deviations. The red line is the ", nRollRec, "-year running mean of the median recruitment deviation. Panels (c \\& e): circles and vertical lines indicate medians and ", ci_level*100, "\\% credible intervals, respectively. Panel (f): phase plot of spawning biomass production for the dive survey period (", new_surv_yr, " to ", assess_yr-1,  "; maximum posterior density estimates). Grey shading becomes darker in chronological order; the triangle indicates ", assess_yr - 1, ". Panels (d \\& f): red lines and shading indicate medians and ", ci_level*100, "\\% confdence intervals, respectively, for the limit reference point $0.3SB_0$, where $SB_0$ is estimated unfished biomass.")`
...
```{r storyboard-hg, out.height="6.5in", fig.cap = ifelse(french, "(ref:storyboard-hg-cap-french)", "(ref:storyboard-hg-cap)")}
...
```{r storyboard-prd, out.height="6.5in", fig.cap = ifelse(french, "(ref:storyboard-prd-cap-french)", "(ref:storyboard-prd-cap)")}
...
```{r storyboard-cc, out.height="6.5in", fig.cap = ifelse(french, "(ref:storyboard-cc-cap-french)", "(ref:storyboard-cc-cap)")}
...
```{r storyboard-sog, out.height="6.5in", fig.cap = ifelse(french, "(ref:storyboard-sog-cap-french)", "(ref:storyboard-sog-cap)")}
...
```{r storyboard-wcvi, out.height="6.5in", fig.cap = ifelse(french, "(ref:storyboard-wcvi-cap-french)", "(ref:storyboard-wcvi-cap)")}
...
(ref:proj-biomass-density-cap) `r paste0("Projected spawning biomass assuming no fishing in ", assess_yr + 1, " $SB_{", assess_yr + 1, "}$ in thousands of tonnes (t) for Pacific Herring in the major stock assessment regions. Solid and dashed vertical lines indicate medians and ", ci_level*100, "\\% confdence intervals for $SB_{", assess_yr + 1, "}$, respectively. Vertical red lines and shaded red areas indicate medians and ", ci_level*100, "\\% confdence intervals for the limit reference point, $0.3SB_0$, respectively, where $SB_0$ is estimated unfshed biomass.")`
