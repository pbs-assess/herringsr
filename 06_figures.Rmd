...
plot_scaled_abundance(major_surv %>% filter(region == major_regions_full[model_ind]),
...
```{r natural-mortality-hg, fig.cap = "asawwwxwxw"}
model_ind <- match(en2fr("HG", french), major_regions_short)
plot_natural_mortality(major_models[[model_ind]],
                       line_size = 2,
                       ribbon_alpha = 0.5,
                       annot = "b",
                       show_x_axis = FALSE,
...
```{r recruitment-hg, fig.cap = "asawwwxwxw"}
model_ind <- match(en2fr("HG", french), major_regions_short)
plot_recruitment(major_models[[model_ind]],
                 point_size = 2,
                 line_size = 2,
                 annot = "c",
                 show_x_axis = FALSE,
...
```{r biomass-catch-hg, fig.cap = "asawwwxwxw"}
model_ind <- match(en2fr("HG", french), major_regions_short)
plot_biomass_catch(major_models[[model_ind]],
                   major_catch %>% filter(region == major_regions_full[model_ind]),
                   point_size = 3,
                   errorbar_size = 1,
                   line_size = 2,
                   ribbon_alpha = 0.5,
...
```{r recruitment-devs-hg, fig.cap = "asawwwxwxw"}
model_ind <- match(en2fr("HG", french), major_regions_short)
plot_recruitment_devs(major_models[[model_ind]],
                      run_mean_yrs = 3,
                      point_size = 2,
                      line_size = 2,
                      errorbar_size = 1,
...
```{r biomass-phase-hg, fig.cap = "asawwwxwxw"}
model_ind <- match(en2fr("HG", french), major_regions_short)
plot_biomass_phase(major_models[[model_ind]],
                   major_catch %>% filter(region == major_regions_full[model_ind]),
                   new_surv_yr = new_surv_yr,
                   point_size = 3,
                   line_size = 2,
