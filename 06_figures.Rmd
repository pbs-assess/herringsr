...
Panel (a): model fit (lines) to scaled spawn survey data (points) in thousands of tonnes (t).
Model fit is the maximum posterior density (MPD); 
...
```{r storyboard-hg, out.height="6.3in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-hg-cap-french)", "(ref:storyboard-hg-cap)")}
...
```{r storyboard-prd, out.height="6.3in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-prd-cap-french)", "(ref:storyboard-prd-cap)")}
...
```{r storyboard-cc, out.height="6.3in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-cc-cap-french)", "(ref:storyboard-cc-cap)")}
...
```{r storyboard-sog, out.height="6.3in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-sog-cap-french)", "(ref:storyboard-sog-cap)")}
...
```{r storyboard-wcvi, out.height="6.3in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-wcvi-cap-french)", "(ref:storyboard-wcvi-cap)")}
