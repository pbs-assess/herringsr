...
Panel (b): posterior estimates of instantaneous natural mortality rate (yr^-1^).
...
for the limit reference point $0.3\mli{SB}_0$, where $\mli{SB}_0$ is estimated unfished spawning biomass.
...
Panneau (b): estimations a posteriori du taux de mortalité naturelle instantanée (an^-1^).
...
```{r storyboard-hg, out.height="6.2in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-hg-cap-french)", "(ref:storyboard-hg-cap)")}
...
```{r storyboard-prd, out.height="6.2in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-prd-cap-french)", "(ref:storyboard-prd-cap)")}
...
```{r storyboard-cc, out.height="6.2in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-cc-cap-french)", "(ref:storyboard-cc-cap)")}
...
```{r storyboard-sog, out.height="6.2in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-sog-cap-french)", "(ref:storyboard-sog-cap)")}
...
```{r storyboard-wcvi, out.height="6.2in", fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-wcvi-cap-french)", "(ref:storyboard-wcvi-cap)")}
