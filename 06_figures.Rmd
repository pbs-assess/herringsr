...
Vertical bars indicate commercial catch, excluding spawn-on-kelp (see Figure \@ref(fig:major-catch) for legend).
...
Panel (f): phase plot of spawning biomass production for the dive survey period (`r new_surv_yr` to `r assess_yr-1`; MPD estimates).
...
Panneau (f): diagramme de phase de la production de la biomasse reproductrice pour la période du relevé de plongée (de `r new_surv_yr` à `r assess_yr-1`; DPM).
