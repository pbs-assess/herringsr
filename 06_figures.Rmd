...
```
<!-- Prince Rupert District Storyboard -->
(ref:storyboard-prd) Model output for Pacific Herring in the Prince Rupert District major stock assessment region. See Figure \@ref(fig:storyboard-hg) for description.
```{r storyboard-prd, out.width = "6in", out.height = "6in", fig.cap = "(ref:storyboard-prd)"}
...
```
<!-- Central Coast Storyboard -->
(ref:storyboard-cc) Model output for Pacific Herring in the Central Coast major stock assessment region. See Figure \@ref(fig:storyboard-hg) for description.
```{r storyboard-cc, out.width = "6in", out.height = "6in", fig.cap = "(ref:storyboard-cc)"}
...
```
<!-- Strait of Georgia Storyboard -->
(ref:storyboard-sog) Model output for Pacific Herring in the Strait of Georgia major stock assessment region. See Figure \@ref(fig:storyboard-hg) for description.
```{r storyboard-sog, out.width = "6in", out.height = "6in", fig.cap = "(ref:storyboard-sog)"}
...
```
<!-- West Coast Vancouver Island Storyboard -->
(ref:storyboard-wcvi) Model output for Pacific Herring in the West Coast Vancouver Island major stock assessment region. See Figure \@ref(fig:storyboard-hg) for description.
```{r storyboard-wcvi, out.width = "6in", out.height = "6in", fig.cap = "(ref:storyboard-wcvi)"}
