...
```{r bc-map, fig.cap = ifelse(french, "(ref:bc-map-cap-fr)", "(ref:bc-map-cap)"), out.width = "100%", fig.pos="H"}
...
(ref:storyboard-hg-cap-fr) Séries chronologiques de sorties de modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr`
...
```{r storyboard-hg, out.height=ifelse(french,"5.4in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-hg-cap-fr)", "(ref:storyboard-hg-cap)")}
...
(ref:storyboard-prd-cap-fr) Séries chronologiques de sorties de modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr`
...
```{r storyboard-prd, out.height=ifelse(french,"5.4in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-prd-cap-fr)", "(ref:storyboard-prd-cap)")}
...
(ref:storyboard-cc-cap-fr) Séries chronologiques de sorties de modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr`
dans la région d’évaluation des stocks majeur de la côte centrale.
Voir la figure \@ref(fig:storyboard-hg) pour la description.

```{r storyboard-cc, out.height=ifelse(french,"5.4in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-cc-cap-fr)", "(ref:storyboard-cc-cap)")}
...
(ref:storyboard-sog-cap-fr) Séries chronologiques de sorties de modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr`
dans la région d’évaluation des stocks majeur du détroit de Georgie.
Voir la figure \@ref(fig:storyboard-hg) pour la description.

```{r storyboard-sog, out.height=ifelse(french,"5.4in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-sog-cap-fr)", "(ref:storyboard-sog-cap)")}
...
(ref:storyboard-wcvi-cap-fr) Séries chronologiques de sorties de modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr`
dans la région d’évaluation des stocks majeur de la côte ouest de l’île de Vancouver.
Voir la figure \@ref(fig:storyboard-hg) pour la description.

```{r storyboard-wcvi, out.height=ifelse(french,"5.4in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-wcvi-cap-fr)", "(ref:storyboard-wcvi-cap)")}
...
(ref:harvest-rate-cap-fr) Série chronologique du taux de récolte effectif $U_t$ pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr` dans les régions d’évaluation des stocks majeurs.
...
(ref:proj-biomass-density-cap-fr) Biomasse reproductrice projetée en supposant qu’il n’y aura pas de pêche en `r assess_yr+1` $\SB_{`r assess_yr+1`}$ en milliers de tonnes pour le hareng du Pacifique dans les régions d’évaluation des stocks majeurs.
