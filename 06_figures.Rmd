...
(ref:proj-biomass-density-cap) `r paste0("Projected spawning biomass assuming no fishing in ", assess_yr + 1, " $SB_{", assess_yr + 1, "}$ in thousands of tonnes for Pacific Herring in the major stock assessment regions. Vertical black lines indicate medians (solid) and ", ci_level*100, "\\% confdence intervals (dashed) for $SB_{", assess_yr + 1, "}$. Vertical red lines indicate medians, and shaded red rectangles indicate ", ci_level*100, "\\% confdence intervals for the limit reference point, $0.3SB_0$, where $SB_0$ is estimated unfshed biomass.")`
