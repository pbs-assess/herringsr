...
(ref:major-catch-cap) `r paste0("Time series of total landed catch in thousands of tonnes (t) of Pacific Herring from ", recent_catch_yr, " to ", major_end_yr, " in the major stock assessment regions. See storyboard figures for catches from ", major_start_yr, " to ", recent_catch_yr-1, ". Legend: 'Other' represents the reduction, the food and bait, as well as the special use fishery; 'RoeGN' represents the roe gillnet fishery; and 'RoeSN' represents the roe seine fishery.")`
