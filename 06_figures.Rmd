...
```
<!-- Haida Gwaii Storyboard -->
(ref:storyboard-hg-cap) Model output for Pacific Herring from `r major_start_yr` to `r major_end_yr` in the Haida Gwaii major stock assessment region.
...
Panels (c & e): timeseries start in `r major_start_yr+age_first`; circles and vertical lines indicate medians and `r ci_level*100`% credible intervals, respectively.
...
(ref:storyboard-hg-cap-french) Production d’un modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr` dans la région d’évaluation des stocks majeur de Haida Gwaii.
...
```{r storyboard-hg, out.height=ifelse(french,"5.5in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-hg-cap-french)", "(ref:storyboard-hg-cap)")}
...
```
<!-- Prince Rupert District Storyboard -->
(ref:storyboard-prd-cap) Model output for Pacific Herring from `r major_start_yr` to `r major_end_yr` in the Prince Rupert District major stock assessment region.
See Figure \@ref(fig:storyboard-hg) for description.

(ref:storyboard-prd-cap-french) Production d’un modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr` dans la région d’évaluation des stocks majeur du district de Prince Rupert.
Voir la figure \@ref(fig:storyboard-hg) pour la description.

```{r storyboard-prd, out.height=ifelse(french,"5.5in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-prd-cap-french)", "(ref:storyboard-prd-cap)")}
...
```
<!-- Central Coast Storyboard -->
(ref:storyboard-cc-cap) Model output for Pacific Herring from `r major_start_yr` to `r major_end_yr` in the Central Coast major stock assessment region.
See Figure \@ref(fig:storyboard-hg) for description.

(ref:storyboard-cc-cap-french) Production d’un modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr` dans la région d’évaluation des stocks majeur de la côte centrale.
Voir la figure \@ref(fig:storyboard-hg) pour la description.

```{r storyboard-cc, out.height=ifelse(french,"5.5in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-cc-cap-french)", "(ref:storyboard-cc-cap)")}
...
```
<!-- Strait of Georgia Storyboard -->
(ref:storyboard-sog-cap) Model output for Pacific Herring from `r major_start_yr` to `r major_end_yr` in the Strait of Georgia major stock assessment region.
See Figure \@ref(fig:storyboard-hg) for description.

(ref:storyboard-sog-cap-french) Production d’un modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr` dans la région d’évaluation des stocks majeur du détroit de Georgie.
Voir la figure \@ref(fig:storyboard-hg) pour la description.

```{r storyboard-sog, out.height=ifelse(french,"5.5in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-sog-cap-french)", "(ref:storyboard-sog-cap)")}
...
```
<!-- West Coast of Vancouver Island Storyboard -->
(ref:storyboard-wcvi-cap) Model output for Pacific Herring from `r major_start_yr` to `r major_end_yr` in the West Coast of Vancouver Island major stock assessment region.
See Figure \@ref(fig:storyboard-hg) for description.

(ref:storyboard-wcvi-cap-french) Production d’un modèle pour le hareng du Pacifique de `r major_start_yr` à `r major_end_yr` dans la région d’évaluation des stocks majeur de la côte ouest de l’île de Vancouver.
Voir la figure \@ref(fig:storyboard-hg) pour la description.

```{r storyboard-wcvi, out.height=ifelse(french,"5.5in","6.2in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-wcvi-cap-french)", "(ref:storyboard-wcvi-cap)")}
