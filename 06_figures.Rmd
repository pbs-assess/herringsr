...
(ref:storyboard-hg-cap-french) \small{Production d’un modèle pour le hareng du Pacifique dans la région d’évaluation des stocks majeur de Haida Gwaii.
...
(ref:harvest-rate-cap) Time series of effective harvest rate $U$ for Pacific Herring from `r major_start_yr` to `r assess_yr` in the major stock assessment regions.
...
Solid and dashed vertical lines indicate medians and `r ci_level*100`% confidence intervals for $\mli{SB}_{`r assess_yr+1`}$, respectively.
