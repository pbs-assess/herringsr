...
$BR_t$ est la biomasse reproductrice estimée pour l’année $t$.
...
Les lignes et rectangles ombragés rouges indiquent les médianes et les intervalles de confiance de `r ci_level*100`% pour le point de référence limite, $0,3BR_0$, où $BR_0$ est la biomasse non exploitée estimée.
