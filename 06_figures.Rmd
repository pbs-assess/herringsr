...
```{r major-catch, fig.cap = "Time series of total landed catch in thousands of tonnes of Pacific Herring from 1951 to 2020 in the major stock assessment regions. Legend: 'Other' represents the reduction, the food and bait, as well as the special use fishery; 'RoeGN' represents the roe gillnet fishery; and 'RoeSN' represents the roe seine fishery."}
