...
Solid and dashed vertical lines indicate medians and `r ci_level*100`% confdence intervals for $\mli{SB}_{`r assess_yr+1`}$, respectively.
Vertical red lines and shaded red areas indicate medians and `r ci_level*100`% confdence intervals for the limit reference point $0.3\mli{SB}_0$, respectively,
where $\mli{SB}_0$ is estimated unfshed biomass.
