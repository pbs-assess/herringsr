...
1. The new SISCAH modelling framework [@johnson2024] was applied to SoG in 2024
[@dfo2025b] and updated for 2025
(Table \@ref(tab:mse-updates)).$^{\ref{fn:dfo2025d}}$

1. The new SISCAH modelling framework
was applied to PRD in 2025.$^{\ref{fn:dfo2025c}}$

1. The new SISCAH modelling framework will be applied to
