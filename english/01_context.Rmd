...
in this assessment estimation of stock status relative to
productive period USRs [@dfo2022a] are included.
...
This assessment includes new science advice on choice of USR points for all
`r number_to_word(length(major_regions_short))`
Pacific Herring major SARs.
...
Draft consultation period occurred September 26 - December 16, 2022; 
DFO internal review period scheduled for fall 2023.}
...
2018, 2019, 2020, 2021, and 2022 MSE analyses
(Section "\nameref{sec:harv-opts}").

<!-- Mandatory last paragraph in this section -->
<!-- TODO: MG pls update process_month to September -->
...
`r rmarkdown::metadata$process_year` on the `r rmarkdown::metadata$title`.
