...
were introduced for the major SARs, and
...
`r rmarkdown::metadata$approval_month` `r rmarkdown::metadata$approval_day`,
`r rmarkdown::metadata$approval_year` on the `r rmarkdown::metadata$title`.
