...
four of the `r number_to_word(length(major_regions_short))`
Pacific Herring major SARs:
`r commify(major_regions_short[major_regions_short != "SoG"])`.
Note that the SoG SAR is assessed in a separate document [@dfo2025b].
...
<!-- TODO: Blurb for last year's assessment -->
1. The 2023 stock assessment includes
... [@dfo2024].

Note that MPs for HG and SoG are not updated through this process. 
...
MPs for SoG are updated in a separate process [@dfo2025b]
