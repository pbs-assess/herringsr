...
DFO. In prep. Prince Rupert District Pacific Herring (\emph{Clupea pallasii})
stock update in 2025.DFO Can. Sci. Advis. Sec. Sci. Advis. Rep.}
and DFO\footnote{\label{fn:dfo2025d}
DFO. In prep. Strait of Georgia Pacific Herring (\emph{Clupea pallasii})
stock update in 2025. DFO Can. Sci. Advis. Sec. Sci. Advis. Rep.}
...
periods identified for each SAR were first implemented in the 2022/23 Integrated 
...
are developed through the HG rebuilding plan process [@dfo2025e].

1. The 2024 stock assessment implemented
MPs from previous years for the PRD, CC, and WCVI SARs [@dfo2025a].

1. The new SISCAH management framework [@johnson2024] was applied to SoG in 2024
[@dfo2025b] and updated for 2025.$^{\ref{fn:dfo2025d}}$

1. The new SISCAH management framework [@johnson2024]
was applied to PRD in 2025.$^{\ref{fn:dfo2025c}}$

1. The new SISCAH management framework [@johnson2024] will be applied for
HG, CC, and WCVI in 2026.
