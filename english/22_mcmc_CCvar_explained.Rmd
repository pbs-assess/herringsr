...
ln() represents the natural logarithm of a parameter.
$R_0$ is unfished age-`r age_first` recruitment;
...
$\rho$ is the fraction of total variance associated with observation error;$q$ is catchability for surface (`r major_start_yr` to `r new_surv_yr-1`; $q_1$) and
...
for the Pacific Herring statistical catch-age model in the Central Coast major stock assessment region. Points indicate estimated unfished spawning biomass.
