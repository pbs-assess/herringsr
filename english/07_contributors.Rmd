...
contributors <- tibble::tribble(
  ...
  "Samuel Johnson",   "Landmark Fisheries Research",       "Author (Ecosystem section)",
  "Chris Rooper",     "DFO Science, Pacific",              "CSAS Chair",
...
```{r, results='asis'}
csasdowntex::csas_table(x = contributors, format = "latex") %>%
