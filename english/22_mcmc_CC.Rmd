...
Autocorrelation was detected within a number of the parameters. Inline with procedures used on WCVI parameter priors were reparameterized. For logarithmic natural mortality the upper bound was reduced from 5 to 3, and the mean was shifted from -0.8 to -0.5 and the sd widened form .4 to 1. For logarithmic initial recruitment the uniform prior was changed to a normal distribution with mean 5 and a sd of 15. The sd for selectivity for gear 3 [TODO: insert geartype name]was widened from 0.25 to 0.5.
