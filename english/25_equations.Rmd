...
A documented list of symbols used in model equations is given
...
<!-- TODO: Write something about phi_q? -->
...
<!-- TODO: Automate these (and all other) values -->
...
<!-- TODO: Use normal distribution function (i.e., \dNorm) -->
...
All estimated selectivity parameters $\vec{\gamma_k}$ are estimated
in log space and
