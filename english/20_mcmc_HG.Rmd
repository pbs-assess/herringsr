...
Autocorrelation was detected within a number of the parameters. Inline with procedures used on WCVI parameter priors were reparameterized. For logarithmic natural mortality the normal prior was set to and initial value of -.5, the upper bound was reduced from 5 to 2, and the mean was shifted from -0.8 to -0.5. For logarithmic initial recruitment the uniform prior was changed to a normal distribution with mean 5 and a still wide sd of 15. The sd for selectivity for gears 2 and 3 [TODO: insert geartype names]was widened from 0.25 to 0.5. For the logarithmic catchability quotient for surface surveys the uniform prior was changed to a normal distribution with mean 0.0 and sd 0.2. 
