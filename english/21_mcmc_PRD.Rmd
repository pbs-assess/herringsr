...
Note: the first row is omitted because
the management procedure specifies no fishing.
Red horizontal and vertical lines show median HR, TAC,
and $\SB_{`r assess_yr+1`}$;
green lines show mean statistics.

```{r hcr-prd-1, fig.asp=1, fig.cap="(ref:hcr-prd-1-cap)"}
region <- "PRD"
...
```{r hcr-prd-2, fig.asp=1, fig.cap="(ref:hcr-prd-2-cap)"}
region <- "PRD"
probs <- confidence_vals
cowplot::plot_grid(
  plot_hcr(
