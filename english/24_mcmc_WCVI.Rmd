...
We attempted to reduce autocorrelation by
using posterior medians from last year as starting values,
increasing the MCMC chain length from 5 million to 10 million iterations, and
increasing the burn-in from 1,000 to 5,000, and then again to 7,000.
The thinning rate was kept the same.
Autocorrelation for both $\hat{a}_1$ and $\hat{\gamma}_1$
was reduced but still persistent.
We also attempted to run the chain for 20 million iterations
keeping every 4,000^th^ sample,
but this was not successful due to computational limitations.
Since these attempts caused a negligible reduction in autocorrelation,
we report the results of the 5 million-run chain to be consistent with other SARs.
