...
(i.e., reduction, food and bait, as well as special use) in WCVI. 
We attempted to ameliorate the issue by
...
had little impact on the estimation of $SB_t$ and $SB_0$, 
...
# TODO: not sure about this burnin
make.traces.plot(
  major_models[[model_ind]], mcmc_burnin = 1000, axis.lab.freq = 200
)
```
