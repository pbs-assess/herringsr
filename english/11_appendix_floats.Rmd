...
(ref:spawn-index-a10-cap) Pacific Herring spawn index in tonnes, and proportion of the spawn index by Section 
from `r  minor_end_yr-num_yrs_tab` to `r minor_end_yr` in the
Area 10 special area.
See Table \@ref(tab:spawn-index-a27) for description.

(ref:spawn-index-a10-cap-fr) Indice du frai en tonnes et proportion de l’indice du frai par section pour
le hareng du Pacifique de `r  minor_end_yr-num_yrs_tab` à `r minor_end_yr` dans la
...
(ref:minor-spawn-index-cap) Time series of Pacific Herring spawn index in thousands of tonnes (t) from `r minor_start_yr_plot` to `r minor_end_yr` in the minor stock assessment regions.
The spawn index has two distinct periods defined by the dominant survey method:
...
(ref:minor-spawn-index-cap-fr) Série chronologique de l’indice du frai en milliers de tonnes pour le hareng du Pacifique de `r minor_start_yr_plot` à `r minor_end_yr` dans les régions d’évaluation des stocks mineurs.
