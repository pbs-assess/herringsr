...
(ref:spawn-section-a27-cap) Spawn survey data for Pacific Herring 
...
(ref:spawn-section-a27-cap-fr) Données de relevé du frai du hareng du Pacifique
...
```{r spawn-section-a27, fig.asp = 1, fig.cap = ifelse(french, "(ref:spawn-section-a27-cap-fr)", "(ref:spawn-section-a27-cap)")}
