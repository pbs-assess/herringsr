...
Pacific Herring spawn index in tonnes, and
...
Pacific Herring spawn index in thousands of tonnes (t) by Section
...
(ref:special-wa-cap) Area 10 special area:
Pacific Herring weight-at-age in kilograms (kg)
...
(ref:special-pa-cap) Area 10 special area:
Pacific Herring proportion-at-age
from `r special_start_yr_plot` to `r special_end_yr`.
See Figure \@ref(fig:major-pa) for description.
...
(ref:special-spawn-index-cap) Area 10 special area:
Pacific Herring spawn index in
thousands of tonnes (t) from `r special_start_yr_plot` to `r special_end_yr`.
See Figure \@ref(fig:major-spawn-index) for description.
