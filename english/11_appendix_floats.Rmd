...
(ref:spawn-section-a27-cap) Pacific Herring spawn index
...
(ref:spawn-section-a27-cap-fr) L’indice du frai
...
(ref:minor-catch-cap) Total landed Pacific Herring catch
...
(ref:minor-catch-cap-fr) Prises totales débarquées en
...
(ref:minor-wa-cap) Pacific Herring mean weight-at-age in kilograms (kg)
...
(ref:minor-wa-cap-fr) Poids moyen à l'âge du hareng du Pacifique en kilogrammes (kg)
...
(ref:minor-pa-cap) Pacific Herring proportion-at-age from
...
(ref:minor-spawn-index-cap) Pacific Herring spawn index
in thousands of tonnes (t) from `r minor_start_yr_plot` to `r minor_end_yr`
in the minor stock assessment regions.
See Figure \@ref(fig:major-spawn-index) for description.

(ref:minor-spawn-index-cap-fr) L’indice du frai en milliers
...
(ref:special-wa-cap) Pacific Herring weight-at-age in kilograms (kg)
from `r special_start_yr_plot` to `r special_end_yr`
in the special area, Area 10.
See Figure \@ref(fig:minor-wa) for description.

(ref:special-wa-cap-fr) Poids selon l’âge en kilogrammes (kg)
...
(ref:special-pa-cap) Pacific Herring proportion-at-age
from `r special_start_yr_plot` to `r special_end_yr`
in the special area, Area 10.
See Figure \@ref(fig:major-pa) for description.
...
(ref:special-spawn-index-cap) Pacific Herring spawn index in
thousands of tonnes (t) from `r special_start_yr_plot` to `r special_end_yr`
in the special area, Area 10.
See Figure \@ref(fig:major-spawn-index) for description.

(ref:special-spawn-index-cap-fr) L’indice du frai en milliers
de tonnes pour le hareng du Pacifique de `r minor_start_yr_plot` à `r minor_end_yr`
dans la zone spéciale, zone 10.
Voir la figure \@ref(fig:major-spawn-index) pour la description.
