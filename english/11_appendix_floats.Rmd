...
(ref:spawn-section-a27-cap) Area 27 SAR: scaled abundance in
thousands of tonnes (t) of Pacific Herring by Section
...
(ref:minor-catch-cap) Total landed Pacific Herring catch in thousands of tonnes (t)
...
`r min(ic_yrs)` to `r max(ic_yrs)` in the minor stock assessment regions (SARs).
...
(ref:minor-spawn-index-cap) Spawn index in thousands of tonnes (t) for Pacific Herring from `r minor_start_yr_plot` to `r minor_end_yr`
...
from `r special_start_yr_plot` to `r special_end_yr` in the special area, Area 10.
...
(ref:special-spawn-index-cap) Spawn index in thousands of tonnes (t) for Pacific Herring from `r minor_start_yr_plot` to `r minor_end_yr`
in the special area, Area 10.
See Figure \@ref(fig:major-spawn-index) for description.
