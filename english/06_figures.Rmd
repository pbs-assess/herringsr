...
(ref:eco-trend-cap) Standardized pressure indicators and 
...
Note that some indicators are specific to Hecate Strait (HS).
Legend: sea surface temperature (SST) in HS (\link{https://www.avl.class.noaa.gov/release/data_available/avhrr/index.htm}{AVHRR satellite});
...
Hake_Acoustic is HS Pacific Hake biomass from the hake stock assessment
and joint United States-Canada acoustic-trawl survey by
...
HGHerringSB_Med is median Haida Gwaii (HG) herring spawning biomass [@dfo2021c];
...
length-weight regression for female HG herring.
