...
The spawn index is scaled to abundance by the median posterior estimate of the
...
Panel (f): phase plot of spawning biomass production for the dive survey period
