...
wa_HG <- read_csv("../../DataSummaries/Summaries/fleetWtAgeHG.csv") 
wa_PRD <- read_csv("../../DataSummaries/Summaries/fleetWtAgePRD.csv") 
wa_CC <- read_csv("../../DataSummaries/Summaries/fleetWtAgeCC.csv")
wa_SOG <- read_csv("../../DataSummaries/Summaries/fleetWtAgeSOG.csv") 
wa_WCVI <- read_csv("../../DataSummaries/Summaries/fleetWtAgeWCVI.csv")
