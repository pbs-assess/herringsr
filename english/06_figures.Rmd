...
herring responses and their status and trends
within the last 5 years of the time series.
Some indicators are specific to the Hecate Strait area
(e.g., sea surface temperature, SST). 
Solid green lines are +/- one standard deviation;
the most recent five years are highlighted in green.
Symbols to the right of graphs indicate trend (top) and status (bottom). 
Trend symbols indicate if there was significantly
increasing (upwards pointing arrow) or
decreasing (downwards pointing arrow) trend,
or neither (horizontal arrow) 
in the most recent 5 years, where there are > 2 years of data available. 
Status symbols indicate if the recent 5- year-average value was
greater than one standard deviation above (+) or below (-)
...
other years interpolated using a 4% population growth rate [@ford2010]
(T. Doniol-Valcroze, DFO, pers. comm.);
HG_StellerSeaLion_Abund = interpolated estimates of Steller Sea Lion abundance
(S. Tucker, DFO, pers.comm.);
AreaOfInterest_B = Biomass of Pacific Hake in the Hecate Strait region
determined from hake stock assessment data in combination with data collected
as part of the joint US-Canada acoustic-trawl survey of Pacific Hake by
the US agencies NOAA/NMFS/AFSC (1995 to 2001),
NOAA/NMFS/NWFSC (2003 to 2019), and
Fisheries and Oceans Canada, Pacific Region (1995 to 2019)
(S. Johnson, Landmark Fisheries Research, pers. comm.);
IPHC = International Pacific Halibut Commission (A. Edwards, DFO, pers. comm.);
HGHerringSB_Med = median Haida Gwaii herring spawning biomass
(from the stock assessment);
Age3_herring_weight_g = mean weight of age-3 herring
(from the stock assessment);
Mean_LWResids_Female = residuals from a double-log-transformed
length-weight regression for female herring.
