...
```{r major-wa-res-doc, fig.asp=ifelse(FALSE, 1.1, 1.15), fig.cap = ifelse(FALSE, "(ref:major-wa-cap-fr)", "(ref:major-wa-cap)")}
...
```{r major-pa-res-doc, fig.asp=ifelse(french, 1.2, 1.25), fig.cap = ifelse(french, "(ref:major-pa-cap-fr)", "(ref:major-pa-cap)")}
