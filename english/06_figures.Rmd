...
ggsave(filename = here("../SISCAH_resDoc2023/figure/AppA", paste0("catchFullTimeSeries.png")),  width=7, height=9, dpi=300)
...
ggsave(filename = here("../SISCAH_resDoc2023/figure/AppA", paste0("catch_pre1970.png")),  width=7, height=9, dpi=300)
...
ggsave(filename = here("../SISCAH_resDoc2023/figure/AppA", paste0("catchShortTimeSeries.png")),  width=7, height=9, dpi=300)
```
...
ggsave(filename = here("../SISCAH_resDoc2023/figure/AppA", paste0("proportion_of_ageHG.png")),  width=8, height=10.5, dpi=300)

pa_SOGplot <- pa_graph(pa_SOG)
ggsave(filename = here("../SISCAH_resDoc2023/figure/AppA", paste0("proportion_of_ageSOG.png")),  width=8, height=10.5, dpi=300)

pa_PRDplot <- pa_graph(pa_PRD)
ggsave(filename = here("../SISCAH_resDoc2023/figure/AppA", paste0("proportion_of_agePRD.png")),  width=8, height=10.5, dpi=300)

pa_CCplot <- pa_graph(pa_CC)
ggsave(filename = here("../SISCAH_resDoc2023/figure/AppA", paste0("proportion_of_ageCC.png")),  width=8, height=10.5, dpi=300)

pa_WCVIplot <- pa_graph(pa_WCVI)
ggsave(filename = here("../SISCAH_resDoc2023/figure/AppA", paste0("proportion_of_ageWCVI.png")),  width=8, height=10.5, dpi=300)
