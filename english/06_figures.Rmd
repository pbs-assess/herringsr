...
<!-- Prince Rupert District Storyboard -->
(ref:storyboard-prd-cap) Model output for the Pacific Herring
from `r major_start_yr` to `r major_end_yr`
...
<!-- Central Coast Storyboard -->
(ref:storyboard-cc-cap) Model output for the Pacific Herring
from `r major_start_yr` to `r major_end_yr`
...
<!-- Strait of Georgia Storyboard -->
(ref:storyboard-sog-cap) Model output for the Pacific Herring
from `r major_start_yr` to `r major_end_yr`
...
<!-- West Coast of Vancouver Island Storyboard -->
(ref:storyboard-wcvi-cap) Model output for the Pacific Herring
from `r major_start_yr` to `r major_end_yr`
