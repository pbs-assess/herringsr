...
```{r storyboard-hg, out.height=ifelse(french,"5.1in","5.8in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-hg-cap-fr)", "(ref:storyboard-hg-cap)")}
...
```{r storyboard-prd, out.height=ifelse(french,"5.1in","5.8in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-prd-cap-fr)", "(ref:storyboard-prd-cap)")}
...
```{r storyboard-cc, out.height=ifelse(french,"5.1in","5.8in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-cc-cap-fr)", "(ref:storyboard-cc-cap)")}
...
dat <- tibble(Spawn = sample(x = 1:100, size = 100, replace = TRUE),
              Year = rep(1:20, times=5),
              Section=rep(letters[1:5], each = 20))
ggplot(data = dat, mapping = aes(x = Year, y = Spawn)) +
        geom_point() +
        geom_line() +
        labs(y = "Scaled abundance (1,000 t)", title = "PLACEHOLDER") +
        facet_grid(Section ~ .)
```
...
```{r storyboard-sog, out.height=ifelse(french,"5.1in","5.8in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-sog-cap-fr)", "(ref:storyboard-sog-cap)")}
...
```{r storyboard-wcvi, out.height=ifelse(french,"5.1in","5.8in"), fig.asp=1, fig.cap = ifelse(french, "(ref:storyboard-wcvi-cap-fr)", "(ref:storyboard-wcvi-cap)")}
