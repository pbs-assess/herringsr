...
plot_d_hg <- plot_biomass_catch(
  ...
  catch_df = ct,
  xlim = xlim_all,
  prod_yrs = prod_period$HG$yrs,
  prop_prod = prod_period$HG$prop,
  translate = french
)
```
...
plot_d_prd <- plot_biomass_catch(
  ...
  catch_df = ct,
  xlim = xlim_all,
  prod_yrs = prod_period$PRD$yrs,
  prop_prod = prod_period$PRD$prop,
  translate = french
)
```
...
plot_d_cc <- plot_biomass_catch(
  ...
  catch_df = ct,
  xlim = xlim_all,
  prod_yrs = prod_period$CC$yrs,
  prop_prod = prod_period$CC$prop,
  translate = french
)
```
...
plot_d_sog <- plot_biomass_catch(
  ...
  catch_df = ct,
  xlim = xlim_all,
  prod_yrs = prod_period$SoG$yrs,
  prop_prod = prod_period$SoG$prop,
  translate = french
)
```
...
plot_d_wcvi <- plot_biomass_catch(
  ...
  catch_df = ct,
  xlim = xlim_all,
  prod_yrs = prod_period$WCVI$yrs,
  prop_prod = prod_period$WCVI$prop,
  translate = french
)
```
