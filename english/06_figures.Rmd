...
create_slide_figures(model_index = model_ind)
```
```{r FSAR-plots-sog, fig.asp= 1.1, fig.cap = "(ref:storyboard-sog-cap)", eval= slides}
...
International Pacific Halibut Commission (IPHC; A. Edwards, DFO, pers. comm.);
...
(ref:eco-trend-cap-fr) Need french title.
