...
```{r storyboard-prd, fig.asp=ifelse(french, 1.0, 1.05), fig.cap = ifelse(french, "(ref:storyboard-prd-cap-fr)", "(ref:storyboard-prd-cap)"), eval = keep_non_CC}
cowplot::plot_grid(
  plot_a_prd,
  plot_b_prd,
  plot_c_prd,
...
```{r storyboard-sog, fig.asp=ifelse(french, 1.0, 1.05), fig.cap = ifelse(french, "(ref:storyboard-sog-cap-fr)", "(ref:storyboard-sog-cap)"), eval = keep_sog & keep_non_CC}
cowplot::plot_grid(
  plot_a_sog,
  plot_b_sog,
  plot_c_sog,
...
if(keep_sog) {
  ...
  m_c <- major_catch %>% filter(region != "Strait of Georgia")
  m_m <- major_models[-sog_ind]
  m_r_f <- major_regions_full[major_regions_full != "Strait of Georgia"]
}
plot_harvest_rate(
  df = m_c,
  models = m_m,
