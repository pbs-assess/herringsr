...
within the last five years of the time series.
Some indicators are specific to the Hecate Strait area
(e.g., sea surface temperature, SST). 
Solid green lines are +/- one standard deviation (SD);
the most recent five years are highlighted in green.
Symbols to the right of graphs indicate trend (top) and status (bottom).
Trend indicates if there was significant increasing (up arrow) or
decreasing (down arrow) trend, or
neither (horizontal) in the most recent five years,
where there are more than two years of data available.
Status indicates if recent average value was
greater than one SD above (+) or below (-)
the time-series average.
Legend:
SST (\link{https://www.avl.class.noaa.gov/release/data_available/avhrr/index.htm}{AVHRR satellite});
bio_mg_mg3 is biomass in $\text{mg}/\text{m}^3$ and
abund_no isnumber in $\text{numbers}/\text{m}^3$
...
Hake_Acoustic is Biomass of Pacific Hake in the Hecate Strait region
determined from hake stock assessment as part of the joint US-Canada
acoustic-trawl survey of Pacific Hake by
US agencies NOAA, NMFS, and AFSC (1995 to 2001),
NOAA, NMFS, and NWFSC (2003 to 2019), and
DFO Pacific Region (1995 to 2019)
(S. Johnson, Landmark Fisheries Research, pers. comm.);
IPHC is International Pacific Halibut Commission (A. Edwards, DFO, pers. comm.);
HGHerringSB_Med is median Haida Gwaii herring spawning biomass and
Age3_herring_weight_g is mean weight of age-3 herring [@dfo2021c]; and
