...
stages of Pacific Herring (from @dfo2022c).

(ref:eco-diagram-cap-fr) Need french title.

```{r eco-diagram, fig.cap = ifelse(french, "(ref:eco-diagram-cap-fr)", "(ref:eco-diagram-cap)"), out.width = "100%"}
knitr::include_graphics(
  here(ifelse(french, "figures/herring_ecosystem_pressures_diagram.png", "figures/herring_ecosystem_pressures_diagram.png"))
)
```
...
knitr::include_graphics(
  here(ifelse(french, "figures/ecosystem_pressure_trends_V2.png", "figures/ecosystem_pressure_trends_V2.png"))
)
```
