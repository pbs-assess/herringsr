...
```{r major-wa, fig.asp=ifelse(FALSE, 1.1, 1.15), fig.cap = ifelse(FALSE, "(ref:major-wa-cap-fr)", "(ref:major-wa-cap)")}
plot_wa(
  df = major_wa,
...
ggsave(wa2, filename = here("../SISCAH_resDoc2023/figure", paste0("weight_age3.png")),  width=12, height=6, dpi=300)
