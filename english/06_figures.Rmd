...
(ref:eco-trend-cap-fr) Indicateurs de pression normalisés sélectionnés et
réponses du hareng du Pacifique (par exemple, état et tendance)
...
La tendance indique une augmentation (flèche vers le haut) ou
une diminution (flèche vers le bas) significative ou
...
ni l'un ni l'autre (point) à la moyenne de la série chronologique.
Il convient de noter que
les indicateurs de pression concernent
le détroit d'Hécate et le détroit de la Reine-Charlotte, et les
réponses sont pour le hareng de Haida Gwaii (HG).
