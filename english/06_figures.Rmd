...
<!-- Haida Gwaii Storyboard -->
(ref:storyboard-hg-cap) Haida Gwaii stock assessment region time series output (`r major_start_yr` - `r major_end_yr`).\
...
Panel (f): Spawning biomass production (dive survey period `r new_surv_yr`-`r assess_yr-1`; median posterior estimates), chronologically shaded light to dark; triangles indicates `r assess_yr-1`.\
Notes: Panels (d & f): Red indicates the median limit reference point = 0.3*(estimated unfished spawning biomass).\
Biomass & catch are in thousands of tonnes (t). Bands & error bars are all `r ci_level*100`% credible intervals.
