...
knitr::include_graphics(
  here(
    ifelse(french, "figures/wcvi_eco_concept_1_fr.png",
           "figures/wcvi_eco_concept_1.png")
  )
)
```
...
knitr::include_graphics(
  here(
    ifelse(french, "figures/wcvi_eco_predators_fr.png",
           "figures/wcvi_eco_predators.png")
    )
)
```
...
knitr::include_graphics(
  here(
    ifelse(french, "figures/wvci_eco_quilt_fr.png",
           "figures/wcvi_eco_quilt.png")
  )
)
```
...
knitr::include_graphics(
  here(
    ifelse(french, "figures/wcvi_eco_concept_2_fr.png",
           "figures/wcvi_eco_concept_2.png")
  )
)
```