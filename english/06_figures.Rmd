...
plot_c_hg_x_none <- plot_recruitment(major_models[[model_ind]],
                              xlim = xlim_all,
                              y_axis_label_newline_length = 17,
                              translate = french)

plot_c_hg_x_down <- plot_recruitment(major_models[[model_ind]],
                              xlim = xlim_all,
                              show_x_axis = TRUE,
                              y_axis_label_newline_length = 17,
...
plot_c_hg_x_up <- plot_c_hg_x_down  + scale_x_continuous(breaks = seq(from = 1900, to = 2100, by = 10),
...
storyboard_hg_ppt_v <- cowplot::plot_grid(plot_a_hg,
                   plot_b_hg,
                   plot_c_hg_x_none,
                   plot_d_hg,
                   plot_e_hg,
...
ggsave(filename = here("figures","storyboard_hg_ppt_v.png"),  width=8, height=4, dpi=300)

storyboard_hg_ppt_h <- cowplot::plot_grid(plot_a_hg,
                   plot_b_hg,
                   plot_c_hg_x_none,
                   plot_d_hg,
                   plot_e_hg,
...
ggsave(filename = here("figures","storyboard_hg_ppt_h.png"),  width=8, height=4, dpi=300)
...
ggsave(filename = here("figures","plot_d_hg_ppt.png"), plot = plot_d_hg,  width=9, height=4.5, dpi=300)

plot_c_hg_ppt <- plot_recruitment(major_models[[model_ind]],
                              xlim = xlim_all,
                              show_x_axis = TRUE,
                              translate = french) + labs(x = NULL)

shortstory_hg_ppt <- cowplot::plot_grid(plot_a_hg,
                   plot_b_hg,
                   plot_c_hg_x_down,
                   plot_d_hg,
                   ncol = 2,
                   align = "v")
ggsave(filename = here("figures","shortstory_hg_ppt.png"),  width=8, height=4, dpi=300)
