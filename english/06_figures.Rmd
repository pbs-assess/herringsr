...
that can affect different life history stages of Pacific Herring (from DFO 2022).
...
(ref:eco-trend-cap) Standardized time series of
selected pressure indicators and herring responses and
their status and trends within the last 5 years of the time series.
...
Symbols to the right of graphs indicate trend (top) and
status (bottom). 
Trend symbols indicate if there was significantly
increasing (upwards pointing arrow),
or decreasing (downwards pointing arrow) trend, or
neither (horizontal arrow) 
in the most recent 5 years,
where there are > 2 years of data available. 
Status symbols indicate if the recent 5-year average value was
greater than one standard deviation above (+) or
