...
(ref:major-incidental-cap) Incidental catch.

(ref:major-incidental-cap-fr) Incidental catch in French.

<!-- TODO: Filter years and regions -->
```{r major-incidental, fig.asp=ifelse(french, 1.2, 1.25), fig.cap = ifelse(french, "(ref:major-incidental-cap-fr)", "(ref:major-incidental-cap)")}
plot_ic(df = ic,
