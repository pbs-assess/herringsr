...
\textbf{Panel (b)}: Instantaneous natural mortality rate
($\text{year}^{\,\text{-}1}$).
...
<!-- TODO: -->
<!-- Remove horizontal lines and dots from figure and caption -->
<!-- Remove "/m3" and "mg/m3" -->
<!-- Change "Spring sea surface temperature" to "Spring SST (March to May)" -->
<!--   and remove from caption -->
<!-- Change "CPUE" to "catch rate"; remove "CPUE" from caption -->
...
Legend: sea surface temperature (SST;
\link{https://www.avl.class.noaa.gov/release/data_available/avhrr/index.htm}{AVHRR satellite});
spring (March to May),
