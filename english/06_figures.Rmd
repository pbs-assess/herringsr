...
create_slide_figures <- function(model_index = 1) {
  ...
  plot_a_multi <- plot_scaled_abundance(major_surv %>% filter(region == major_regions_full[model_index]),
  ...
  plot_b_multi <- plot_natural_mortality(major_models[[model_index]],
                                      xlim = xlim_all,
                                      show_x_axis = TRUE,
                                      y_max = M_max,
                                      y_axis_label_newline_length = 20,
  ...
  plot_c_multi <- plot_recruitment(major_models[[model_index]],
                                xlim = xlim_all,
                                show_x_axis = TRUE,
  ...
  plot_d_multi <- plot_biomass_catch(major_models[[model_index]],
                                  catch_df = ct,
                                  xlim = xlim_all,
                                  y_axis_label_newline_length = 20,
                                  label_points = TRUE,
                                  ...
                                  translate = french)
  plot_e_multi <- plot_recruitment_devs(major_models[[model_index]],
                                     run_mean_yrs = nRollRec,
                                     xlim = xlim_all,
                                     y_axis_label_newline_length = 20,
                                     prod_yrs = prod_period[[model_index]]$yrs,
                                     translate = french)
  plot_f_multi <- plot_biomass_phase(major_models[[model_index]],
                                  catch_df = ct,
                                  new_surv_yr = new_surv_yr,
                                  y_axis_label_newline_length = 20,
                                  translate = french)
  ...
  ggsave(filename = here(knitr_figs_dir, paste0("storyboard_", region_abbreviation, "_ppt.png")),  width=12, height=6, dpi=300)
  ...
  ggsave(filename = here(knitr_figs_dir, paste0("shortstory_", region_abbreviation, "_ppt.png")),  width=8, height=5, dpi=300)
  plot_a_single <- plot_scaled_abundance(major_surv %>% filter(region == major_regions_full[model_index]),
                                     major_models[[model_index]],
                                     surv_type,
                                     new_surv_yr = new_surv_yr,
                                     xlim = xlim_all,
                                     ...
                                     prod_yrs = prod_period[[model_index]]$yrs,
                                     translate = french)
  ggsave(filename = here(knitr_figs_dir, paste0("plot_a_", region_abbreviation, "_ppt.png")), plot = plot_a_single,  width=10, height=5, dpi=300)
  
  plot_d_single <- plot_biomass_catch(major_models[[model_index]],
                                  catch_df = ct,
                                  xlim = xlim_all,
                                  line_size = 1,
                                  x_axis_label_size = 20,
                                  ...
                                  prop_prod = prod_period[[model_index]]$prop,
                                  translate = french) 
  ggsave(filename = here(knitr_figs_dir, paste0("plot_d_", region_abbreviation, "_ppt.png")), plot = plot_d_single,  width=9, height=5, dpi=300)
}
...
```{r  ppt-plots-hg-2, fig.asp = 1.1, fig.cap = "(ref:storyboard-hg-cap)", eval= slides}
...
```{r ppt-plots-prd, fig.asp=1.1, fig.cap = "(ref:storyboard-prd-cap)", eval= slides}
reg <- regions$Region
...
```
```{r ppt-plots-cc, fig.asp=1.1, fig.cap = "(ref:storyboard-cc-cap)", eval= slides}
reg <- regions$Region
region_abbreviation <-reg[model_ind]
plot_a_multi <- plot_scaled_abundance(major_surv %>% filter(region == major_regions_full[model_ind]),
                                   major_models[[model_ind]],
