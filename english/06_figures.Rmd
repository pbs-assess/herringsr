...
```{r major-wa, fig.asp=ifelse(french, 1, 1.15), fig.cap = ifelse(french, "(ref:major-wa-cap-fr)", "(ref:major-wa-cap)")}
plot_wa(
  df = major_wa,
...
```{r storyboard-hg, fig.asp=ifelse(french, 0.8, 1.05), fig.cap = ifelse(french, "(ref:storyboard-hg-cap-fr)", "(ref:storyboard-hg-cap)")}
cowplot::plot_grid(
  plot_a_hg,
  plot_b_hg,
  plot_c_hg,
...
```{r storyboard-prd, fig.asp=ifelse(french, 0.8, 1.05), fig.cap = ifelse(french, "(ref:storyboard-prd-cap-fr)", "(ref:storyboard-prd-cap)")}
cowplot::plot_grid(
  plot_a_prd,
  plot_b_prd,
  plot_c_prd,
...
```{r storyboard-cc, fig.asp=ifelse(french, 0.8, 1.05), fig.cap = ifelse(french, "(ref:storyboard-cc-cap-fr)", "(ref:storyboard-cc-cap)")}
cowplot::plot_grid(
  plot_a_cc,
  plot_b_cc,
  plot_c_cc,
...
```{r storyboard-sog, fig.asp=ifelse(french, 0.8, 1.05), fig.cap = ifelse(french, "(ref:storyboard-sog-cap-fr)", "(ref:storyboard-sog-cap)")}
cowplot::plot_grid(
  plot_a_sog,
  plot_b_sog,
  plot_c_sog,
...
```{r storyboard-wcvi, fig.asp=ifelse(french, 0.8, 1.05), fig.cap = ifelse(french, "(ref:storyboard-wcvi-cap-fr)", "(ref:storyboard-wcvi-cap)")}
cowplot::plot_grid(
  plot_a_wcvi,
  plot_b_wcvi,
  plot_c_wcvi,
