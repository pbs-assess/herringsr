...
# ggsave(filename = here("../herringsr_figures/", paste0("catchFullTimeSeries.png")),  width=7, height=9, dpi=300)
...
# ggsave(filename = here("../herringsr_figures/", paste0("catch_pre1970.png")),  width=7, height=9, dpi=300)
...
# ggsave(filename = here("../herringsr_figures/", paste0("catchShortTimeSeries.png")),  width=7, height=9, dpi=300)
```
...
# ggsave(filename = here("../herringsr_figures/", paste0("storyboard_", region_abbreviation, "_ppt.png")),  width=12, height=6, dpi=300)
...
# ggsave(filename = here("../herringsr_figures/", paste0("shortstory_", region_abbreviation, "_ppt.png")),  width=8, height=5, dpi=300)
plot_a_single <- plot_scaled_abundance(major_surv %>% filter(region == major_regions_full[model_ind]),
                                   ...
                                   translate = french)
# ggsave(filename = here("../herringsr_figures/", paste0("plot_a_", region_abbreviation, "_ppt.png")), plot = plot_a_single,  width=10, height=5, dpi=300)
...
plot_d_single <- plot_biomass_catch(major_models[[model_ind]],
                                ...
                                prod_yrs = 1975:1985,
                                translate = french) 
# ggsave(filename = here("../herringsr_figures/", paste0("plot_d_", region_abbreviation, "_ppt.png")), plot = plot_d_single,  width=9, height=5, dpi=300)
```
...
plot_d_single <- plot_biomass_catch(
  ...
  label_points = TRUE,
  translate = french) 
# ggsave(filename = here("../herringsr_figures/", paste0("plot_d_", region_abbreviation, "_ppt.png")), plot = plot_d_single,  width=9, height=4.5, dpi=300)
```
...
plot_d_single <- plot_biomass_catch(
  ...
  label_points = TRUE,
  translate = french) 
#folder "herringsr_figures" must exist at the same level 
# as the herringsr folder for the next line to work.
# ggsave(filename = here("../herringsr_figures/", paste0("plot_d_", region_abbreviation, "_ppt.png")), plot = plot_d_single,  width=9, height=4.5, dpi=300)
```
...
# ggsave(filename = here("../herringsr_figures/", paste0("proportion_of_ageHG.png")),  width=8, height=10.5, dpi=300)
# 
# pa_SOGplot <- pa_graph(pa_SOG)
# ggsave(filename = here("../herringsr_figures/", paste0("proportion_of_ageSOG.png")),  width=8, height=10.5, dpi=300)
# 
# pa_PRDplot <- pa_graph(pa_PRD)
# ggsave(filename = here("../herringsr_figures/", paste0("proportion_of_agePRD.png")),  width=8, height=10.5, dpi=300)
# 
# pa_CCplot <- pa_graph(pa_CC)
# ggsave(filename = here("../herringsr_figures/", paste0("proportion_of_ageCC.png")),  width=8, height=10.5, dpi=300)
# 
# pa_WCVIplot <- pa_graph(pa_WCVI)
# ggsave(filename = here("../herringsr_figures/", paste0("proportion_of_ageWCVI.png")),  width=8, height=10.5, dpi=300)
```