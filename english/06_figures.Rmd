...
Notes: Les données pour `r max(ic_yrs)` peuvent être incomplètes.
...
(ref:spawn-section-cc-cap) Spawn index in thousands of tonnes (t) for selected sections  `r major_start_yr` to `r major_end_yr`
...
(ref:spawn-section-cc-cap-fr)Indice de frai en milliers de tonnes (t) pour les sections sélectionnées `r major_start_yr` à `r major_end_yr`
