...
<!-- TODO: May need to edit these next few sentences -->
...
As with other years, missing age data for 2020 were imputed by the following method.. as described in the Section '\nameref{sec:biol-data}.'
