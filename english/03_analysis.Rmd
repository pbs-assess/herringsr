...
The time series of estimated spawning biomass reached an estimated peak in the mid to late 1970s during a time period of lowest
observed model estimates of natural mortality and variable estimated recruitment (Figure \@ref(fig:storyboard-wcvi)a, b, c). 
...
at which point productivity has increased with higher than average recruitment and declining natural mortality estimates resulting in increasing spawning biomass estimates (Figure \@ref(fig:storyboard-wcvi)a, b, f).
...
There is modest evidence for an increase in biomass above the LRP since 2016 and positive production estimates in the last few years.
...
for the "other" fisheries category (i.e., reduction, food and bait, as well as special use). These were largely ameliorated by a reparameterization of parameter priors [@dfo2021c]).
