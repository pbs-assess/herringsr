...
over three Pacific Herring generations
(i.e., achieve a target biomass; $P(\SB_t \geq SB_{targ}) \geq 0.5$),
...
The details of the review process are summarized in @dfo2023a, and there were
two key recommendations for implementation:
...
DFO is committed to these recommendations prior to implementation of 
the SISCAH modelling framework.
...
<!-- TODO: Waiting on PRD, CC, SoG, and WCVI; change statement 'for most areas.' (line below) -->

In `r assess_yr`, local observations were provided by
coastal First Nations participants for most areas.

The following descriptions were contributed by representatives of First Nations communities.
