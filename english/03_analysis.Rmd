...
Next, the first `r number_to_word(mcmc_burnin)` samples are discarded
(i.e., burn-in),
...
increasing estimated natural mortality
...
updates in 2022 [@dfo2022b], included here,
show probabilities ranging from 67% to 80% (Table \@ref(tab:decision-sog)).
