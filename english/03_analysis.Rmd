...
distribution, growth, migration, productivity, reproduction, and survival 
(Boldt et al. 2022).
...
sources (e.g., Boldt et al. 2023), based upon the 
Driver-Pressure-State-Impact-Response (DPSIR) framework (Elliott 2002). 
Indicators generally corresponded to published lists of standard indicators 
(e.g., Bundy et al. 2017; Boldt et al. 2014; Takahashi and Perry 2019), 
with consideration for the spatial scales and herring distribution by season 
and life history stage (Boldt et al. in prep). Data exploration and analyses 
were undertaken to collate and reduce the number of indicators according to 
the methods of Boldt et al. (2021) and indicator selection criteria 
(Rice and Rochet 2005).  A multi-model approach, including single 
...
and non-linear relationships (Boldt et al. in prep).
...
(Mackas et al. 2001; Hourston and Thomson 2019; (Figure \@ref(fig:eco-diagram)). 
