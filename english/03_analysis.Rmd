...
dropping estimated natural mortality rates.
Estimated natural mortality started raising at that point
...
before falling to persistent historic lows in estimated biomass from 2000 to 2010
...
recover by the mid-1980s to about 50% of the historic high
...
however it successfully resumed in 2021 and continued in 2022
(Table \@ref(tab:annual-sok-catch)).
...
Biomas and production has been maintained in part by
...
average ~12% [needs updating would be nice to auto update]
(Figure \@ref(fig:harvest-rate)).
...
No new MPs were included however probability metrics
for candidate USRs were estimated.
