...
Environmental variability is modeled implicitly via
time varying natural mortality and recruitment, however,
ecosystem indicators are not directly incorporated into the assessment model.
@boldt2022 identified mechanistic hypotheses that link
environmental and biological pressures to Pacific Herring outcomes (responses),
such as distribution, growth, migration, productivity,
...
available to herring [@mackas2001; @hourston2019], as well as predation and
