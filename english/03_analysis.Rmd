...
And while 2020 is one of the three highest peaks in estimated spawning biomass, 
...
Some increases in estimated biomass occur in 2015 with 
...
to no catch or age composition data for that fishery in the 1970's. 
...
catch from 1978-1996 (range: 0 t to 0.84 t), for which
...
The draft for consultation continues via a 
...
from September 26 – December 16, 2022. 
Final edits are underway and a DFO internal review period is scheduled for fall 2023.
...
the harvest recommendation for the Haida Gwaii stock in `r assess_yr + 1` is 0&nbsp;t.
