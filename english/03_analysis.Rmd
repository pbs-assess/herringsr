...
Compared to 2020 and 2021, the COVID-19 pandemic had fewer impacts
to Pacific Herring data collection and analysis in 2022.
...
by the COVID-19 pandemic in 2022.
...
<!-- TODO: Add FN observations from Victor. -->

### Prince Rupert District

<!-- TODO: Add FN observations from Penny. -->

### Central Coast

<!-- TODO: Add FN observations from Larry (Area 06) and Mike (Area 07). -->
...
An analysis of USR options was undertaken beginning in the winter of 2022, with
results presented in the following Science Response (currently in press).
<!-- TODO-MG: please add a footnote to the 'currently in press' (prev line.)
Footnote should read: CSAS Science Response: August 30, 2022 Management 
Strategy Evaluation Update and Evaluation of Upper Stock Reference Point Options 
for Pacific Herring (Clupea pallasii) in British Columbia, Canada-->
