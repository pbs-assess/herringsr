...
Unlike impacts of COVID-19 in 2020 and 2021,
collection and analysis of biological 
data was not affected by the COVID-19 pandemic in 2022.
...
Estimated spawning biomass historic lows occurred in the late 1960s
predicated by
...
in the estimated low biomass was spurred by through the late 1990s
by above average estimated recruitment
before falling to persistent historic lows in estimated biomass
from 2000 to 2010
...
In response the stock collapsed to the lowest estimated values
of spawning biomass. 
Dropping estimated natural mortality rates seem
to have helped the spawning biomass
...
before stabilizing at a relatively low level (but above historic lows)
by around 2005, 
which was maintained until 2018.
The estimated stock biomass has shown modest increases in the years since with 
above average age-`r age_first`+ recruitment in 2014, 2017 and 2018 and 
...
during which the effective harvest rate $U_t$
was estimated to be at or below 20% 
...
following low estimated natural mortality rates and
one of the highest estimated 
...
historically low estimated biomass
...
Survey biomass increased in 2019 and 2020,
and in the 2021-2022 year productivity
was positive however biomass estimates.
...
An increasing trend has been observed in all but the 
...
for candidate USRs were estimated.Management procedures, harvest options, 
and updated probabilities of 
...
conservation objective with a minimum 75% probability
under either DDM or DIM OM scenario.
...
all evaluated MP's met the conservation objective (range 75-87%) in both
...
during the recent 3-5 year period. 
...
year-to-year changes in age composition,
spawn distribution, or
spawning behaviour.
...
between the two gears is not large enough
to impact the status of the population.
