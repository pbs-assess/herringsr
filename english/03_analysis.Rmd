...
The assessment approach used for Pacific Herring models environmental 
variability implicitly via natural mortality process that is time varying
(e.g., implied predation impacts) and via recruitment process variability; 
however, ecosystem indicators are not directly incorporated into a stock
assessment model.
