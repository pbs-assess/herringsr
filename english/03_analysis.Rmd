...
have increased in the last 3-5 years.
...
Each update shows differences in MP performance against the conservation 
objective over both OM scenarios.
Initial simulations show the probability of meeting the conservation 
objective ranging from 91% to 100% [@dfo2019a], depending on the scenario and MP.
...
These comparisons highlights the importance of considering the learned
lessons from the MSE process (Section "Management strategy evaluation")
when selecting or eliminating MPs.
<!-- TODO-MG: make/ add Section reference for previous line-->
In this case it may be important to consider how these recent most MP updates 
for SoG (Table \@ref(tab:decision-sog)) may be influenced by the the last 
three to five years of natural mortality trends used to condition the OM. 
...
However MPs with 20% harvest rates, e.g., HS30-60_HR20 
and minE30_HR20, which were previously shown to meet the minimum 75% 
probability level (@dfo2019a and @dfo2021b) now show probability values ranging
from 67% to 74% (across both DDM and DIM OMs).

In situations where estimated natural mortality trends show a sudden increasing
or decreasing trend in the terminal three to five years, MP evaluations may more 
reliably reflect the relative ranking of MP performance, as opposed to realized 
...
for WCVI showed the conservation objective is met
