...
results presented in a Science Response (currently in press).
...
<!-- TODO- ensure order here matches the table columns-->

1. Average spawning biomass during a productive period, $0.80\SB_{\mli{productive_period}}$ (80\% Bmsy proxy),
...
$\SB_{\mli{long-term ave}}$.

<!-- TODO-JC: update this text-->
...
The simulation-evaluations did not select a single USR as this needs to
be informed by the consultative process which is on-going.
Final USR choices for major SARs will be reported in the 2022 draft Herring IFMP.
