...
DFO is committed to these recommendations prior to implementation of the
...
methods for estimating SOK mortality are developed within
...
<!-- TODO: MG, is this statement still correct, 2022 is incomplete? -->
...
have chain length `r number_to_word(mcmc_length)`
...
for the SISCAH modelling framework [@dfo2033a], but are not implemented here.
...
We see this balance play out in estimated production which was high in 2019/2020,
...
catch from 1978-1996, ranging from 0 t to 0.84 t for which 
there was no age composition. This didn't 
