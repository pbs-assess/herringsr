...
herring (SISCAH) modelling framework for the SoG SAR$^{\ref{fn:sogfsar}}$.
...
but began a steady decline in the late-1980s,
...
with above average age-`r age_first` recruitment
in 2014, 2018 and, 2022 and stable natural mortality rates
(Figure \@ref(fig:storyboard-prd)c, d, f). 
Productivity in recent years is relatively high compared to the last 30 years,
with the highest estimated productivity in 2022
(Figure \@ref(fig:storyboard-prd)f) and
with natural mortality decreasing in the last handful of years.
...
an estimated production close to neutral for 2021 and 2023, and
negative for 2023
...
These were largely ameliorated this year by changing parameter priors.
...
and MPs for SoG are provided in DFO (In Prep.).$^{\ref{fn:sogfsar}}$
...
Spawning biomass increased above $0.3\SB_0$ in 2019
...
Harvest options for `r assess_yr + 1`,
resulting from simulation-tested MPs
...
For ease of comparison with MP performance evaluation,
harvest options are presented along side MP performance metrics
for both OM scenarios 
(Table \@ref(tab:decision-prd)).
...
This accounts for the mid-trophic level (i.e., middle-of-the-food-chain)
...
herring [@mackas2001; @hourston2019], as well as
