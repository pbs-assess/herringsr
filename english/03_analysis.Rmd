...
In 2022 management procedure evaluation tables (Table XX to XXX) were updated. 

TODO: JC Mention June 2023 CSAS csas and commitment for transition plan
for implementing the new operating model. (SP SFD)

In June 2023 a CSAS meeting was held to evaluate the application 
of a new modelling framework for the Assessment of Pacific Herring major stocks
and implementation in the MSE process. 

From that meeting came the following recomendations:

•	A minimum 3 year cycle for MSE updates is recommended, 
unless new evidence reveals exceptional circumstances.
•	A process for implementing the new assessment and operating model, 
...
With those recommendations in mind we have begun consultations. ...
...
These two hypotheses are captured as operating model (OM) scenarios in @benson2022.
