...
(Figure \@ref(fig:storyboard-hg)a, b, & e). Under variable 
...
Survey biomass increased in 2019 and 2020, and in the 2021-2022 year productivity
was positive however biomass estimates are highly uncertain given persistent high natural mortality.
...
with an moderate increase from 2019 to 2022.

In the summer 2022, we updated the conditioning of the MSE operating model
...
presented in September 2019 [@dfo2020a] and 2020 [@dfo2021] and 2022 (in press).
No new MPs were included however probability metrics for candidate USRs were
estimated.
<!-- TODO-: Make %'s auto update.-->
...
above the LRP with 85 to 100% probability, over both OM scenarios
...
<!-- TODO-MG: Update the average effective harvest rate (Make automatically update?).-->
average ~12% [needs updating would be nice to auto update] (Figure \@ref(fig:harvest-rate)),
The stock showed no sign of growth before 2018 and
...
however these states were entered rapidly and were preceded by high biomass levels
[@kronlund2017].
...
Harvest options under the two most robust OM scenarios are also included.
...
An increasing trend has been observed in since in all but the 
most recent years (Figure \@ref(fig:storyboard-cc)a).

In the 2022 summer we updated the conditioning of the MSE 
operating model with 2021 spawn, catch, and biological data. 
We re-ran MSE simulations to generate updated probability values for 
the MPs presented in September 2019 [@dfo2020a], 2020 [@dfo2021].
No new MPs were included however probability metrics for candidate USRs were estimated.

Management procedures, harvest options, and updated probabilities of 
obtaining objectives for 2022 under the two OM scenarios are presented 
...
conservation objective with a minimum 75% probability under either DDM or DIM OM 
scenario.

The updated simulations show that MPs with harvest rates at 5% and 10% 
maintain spawning biomass above the LRP with 80 to 100% probability over all 
three OM scenarios (Table \@ref(tab:decision-cc)).
Since multiple MPs meet the conservation objective of maintaining spawning 
biomass above the LRP with at least 75%, other socio-economic reasons may
drive the choice for a particular MP. 
...
with 75% probability or higher for two generations across both the OM scenarios.
...
In 2022, with updated 2021 data, closed-loop feedback simulations for the WCVI showed
the conservation objective could be met under the DDM OM scenario
