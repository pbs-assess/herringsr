...
DFO$^{\ref{fn:dfo2025c}}$ and DFO$^{\ref{fn:dfo2025d}}$
respectively, some tables and figures in this document include
...
Commercial SOK fisheries operated both in the CC and WCVI in `r this_season`.
...
Recommendations for addressing this uncertainty require quantifying
...
new modelling framework [@dfo2023a]
implemented for PRD (DFO. In prep.)$^{\ref{fn:dfo2025c}}$,
and also within the HG rebuilding plan$^{\ref{fn:rebuild}}$
however those approaches are not
