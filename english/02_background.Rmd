...
`r n2w(length(major_regions_short))` major and
`r n2w(length(minor_regions_short))` minor
...
2018 decision. 
Version 2 of the 2021 FMP, issued on December 2, 2021,
was the first Multi-Species FMP developed
following the British Columbia Court of Appeal (BCCA)
...
`r n2w(length(major_regions_short))`
