...
For the minor SARs, we present available catch data, biological data, and spawn survey data
(see Section "\nameref{sec:app-minor}").
Beginning in 2021 we include similar data for the special area, Area 10
(see Section "\nameref{sec:app-special}").
Formal analyses of stock trends are not included for minor SARs and special areas due to
data availability.
