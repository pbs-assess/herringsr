...
food and bait (FB),
special use (SU),
spawn-on-kelp (SOK) products, and
roe herring.
...
<!-- TODO: JC update this paragraph with 2021/22 FMP (MG sent to Andrea -->
<!-- Gorurk for review on Sept 1). Also, Bryan doesn't think we are -->
<!-- saying "T'aaq-wiihak First Nations" anymore -->
...
The DFO has developed a 2020/21 Five Nations
Multispecies Fishery Management Plan (FMP) that includes herring,
in consultation with the Five Nations.
Feedback provided by the Five Nations during consultations was considered and
incorporated into the 2020/21 FMP by DFO where possible. 
