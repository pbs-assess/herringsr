...
(ref:cc-traces-figure) Trace plots for Markov chain Monte Carlo (MCMC) output of
...
ref:cc-autocor-figure) Auto-correlation plots for Markov chain Monte Carlo (MCMC) output of
estimated parameters for the Central Coast major stock assessment region.
...
(ref:cc-pairs-figure) Pairs plots for Markov chain Monte Carlo (MCMC) output of
estimated parameters for the Central Coast major stock assessment region.
See Table \@ref(tab:hg-parameter-est-table) and
Figure \@ref(fig:cc-traces-figure) for description.
