...
```{r cc-priors-posts-figure, fig.cap = "Prior probability distributions (lines) with comparative posterior histograms (bars) used in the Central Coast major stock assessment region. Parameters $q_k$ represent gears where: $k=1$ is the surface survey and $k=2$ is the dive survey. The dotted red lines are the MPD estimates."}
...
(ref:cc-biomass-retro-figure) MPD biomass with retrospectivces for the Central Coast major stock assessment region.
