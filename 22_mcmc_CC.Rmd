...
cap <- paste0("Posterior (5\\textsuperscript{th} percentile, Median, and ",
              ...
              "parameters from the Central Coast major stock assessment ",
...
(ref:cc-pairs-figure) Pairs plots for MCMC output of estimated parameters in for the Central Coast major stock assessment region. See Figure \@ref(fig:cc-traces-figure) for parameter descriptions.
