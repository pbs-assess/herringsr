...
```{r cc-priors-posts-figure, fig.cap = "(ref:cc-priors-posts-figure-cap)"}
...
```{r cc-traces-figure, fig.asp=1, fig.cap="(ref:cc-traces-figure-cap)"}
...
Figure \@ref(fig:cc-traces-figure-cap) for description.

```{r cc-autocor-figure, fig.asp=1, fig.cap = "(ref:cc-autocor-figure-cap)"}
...
```{r cc-pairs-figure, fig.asp=1, fig.cap = "(ref:cc-pairs-figure-cap)"}
...
```{r cc-biomass-retro-figure, fig.cap = "(ref:cc-biomass-retro-figure-cap)"}
