...
et histogrammes a posteriori comparatifs (barres) utilisés dans la région d’évaluation des stocks majeur de la côte centrale.
...
(ref:cc-traces-cap-fr) French caption.
...
estimated parameters for the Central Coast major stock assessment region.
See Table \@ref(tab:hg-parameter-est) and Figure \@ref(fig:cc-traces) for description.

(ref:cc-autocor-cap-fr) French caption.
...
(ref:decision-cc-cap) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Central Coast region, rows 1-4 in Table \\@ref(tab:decision-cc). Red horizontal and vertical lines show median harvest rate, TAC, and projected $\\SB_t$; mean statistics shown with green lines.")`
```{r hcr-cc, fig.cap="(ref:decision-cc-cap)"}
region <- "CC"
...
(ref:decision-cc-2-cap) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Central Coast region, rows 5-8 in Table \\@ref(tab:decision-cc). Red horizontal and vertical lines show median harvest rate, TAC, and projected $\\SB_t$; mean statistics shown with green lines.")`
```{r hcr-cc-2, fig.cap="(ref:decision-cc-2-cap)"}
region <- "CC"
probs <- confidence_vals 
...
(ref:decision-cc-3-cap) `r paste0("Projected spawning biomass for ", assess_yr + 1, " compared to harvest rate and TAC for the Central Coast region, rows 9-10 in Table \\@ref(tab:decision-cc). Red horizontal and vertical lines show median harvest rate, TAC, and projected $\\SB_t$; mean statistics shown with green lines.")`
```{r hcr-cc-3, fig.cap="(ref:decision-cc-3-cap)"}
region <- "CC"
probs <- confidence_vals 
