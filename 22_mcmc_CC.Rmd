...
comparative posterior histograms (bars) for Pacific Herring in the Central Coast major stock assessment region.
...
estimated parameters for Pacific Herring in the Central Coast major stock assessment region.
See Table \@ref(tab:hg-parameter-est) and Figure \@ref(fig:hg-traces) for description.

(ref:cc-traces-cap-fr) Tracés des résultats de simulation Monte Carlo par chaîne de Markov pour les paramètres estimés
...
paramètres estimés dans la région d’évaluation des stocks majeur de la côte centrale.
Voir le tableau \@ref(tab:hg-parameter-est) et la figure \@ref(fig:hg-traces) pour la description.
...
les paramètres estimés dans la region d’évaluation des stocks majeur de la côte centrale.
Voir le tableau \@ref(tab:hg-parameter-est) et la figure \@ref(fig:hg-traces) pour la description.
...
for Pacific Herring in the Central Coast major stock assessment region.
...
pour la région d'évaluation des stocks majeur de la côte centrale.
