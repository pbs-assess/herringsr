...
Pacific Herring in BC are managed as `r number_to_word(length(major_regions_short))` major and `r number_to_word(length(minor_regions_short))` minor stock assessment regions (SARs; <!--\autoref{figBC}-->).
