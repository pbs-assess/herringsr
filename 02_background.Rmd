...
Pacific Herring in BC are managed as `r number_to_word(length(allRegions$major))` major and `r number_to_word(length(allRegions$minor))` minor stock assessment regions (SARs; \autoref{figBC}).
The major SARs are `r paste(allRegionNames$major, collapse = " ")`. The minor SARs are `r paste(allRegionNames$minor, collapse = " ")`.
We conduct formal analyses of stock trend information for the Pacific Herring major SARs. For the minor SARs, we present catch data, biological data, and spawn survey data (<!-- \nameref{appMinor} -->).

<!-- \subsection{Description of the fishery} -->

<!-- At present, \fishName{} fisheries in BC consist of commercial fishing opportunities for food and bait (FB), spawn-on-kelp (SOK) products, and roe herring. -->
<!-- There are also opportunities for First Nations food, social, and ceremonial (FSC) fisheries, as well as recreational fishing. -->

<!-- In \Sexpr{thisSeason}, the primary \fishName{} fisheries were seine roe and gillnet roe fisheries, with a combined coast wide catch in \Sexpr{thisSeason} of \Sexpr{finalYrCatchRoe} tonnes (t), and the FB seine fishery with a coast wide catch of \Sexpr{finalYrCatchOther}~t. -->
<!-- The roe fishery was operational in SoG and PRD. -->
<!-- The spawn-on-kelp (SOK) fishery was operational in PRD and CC, and special use (SU) minor fishery was operational in SoG only. -->
