...
In `r this_season`, the primary Pacific Herring fisheries were seine roe and gillnet roe fisheries, with a combined coast wide catch in `r this_season` of \Sexpr{finalYrCatchRoe} tonnes (t), and the FB seine fishery with a coast wide catch of \Sexpr{finalYrCatchOther}~t.
